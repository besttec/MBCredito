...
CREATE TABLE `clientes` (
  ...
  `obs_erro_cliente` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `consulta_cliente` (
  ...
  `competencia` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `obs_cliente` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `consulta_cliente` VALUES (1,39,1060.80,272.25,788.55,1,'JOSE FRANCISCO DA ROCHA','01/2015','CONTA CORRENTE','2015-01-01','2015-01-31','42 APOSENTADORIA POR TEMPO DE CONTRIBUICAO','BRASIL','RUA DO LIVRAMENTO-MACEIO','408135','RUA DO LIVRAMENTO, 120 - DO SUBSOLO AO 3 ANDAR','2015-02-03','2015-03-31',NULL),(2,39,1060.80,272.25,788.55,1,'JOSE FRANCISCO DA ROCHA','01/2015','CONTA CORRENTE','2015-01-01','2015-01-31','42 APOSENTADORIA POR TEMPO DE CONTRIBUICAO','BRASIL','RUA DO LIVRAMENTO-MACEIO','408135','RUA DO LIVRAMENTO, 120 - DO SUBSOLO AO 3 ANDAR','2015-02-03','2015-03-31',NULL);
...
CREATE TABLE `convenio` (
  ...
  `nome_convenio` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `convenio` VALUES (1,'103824079','103824079');
...
INSERT INTO `emprestimos` VALUES (1,1,'Consig. Emprest.',272.25,NULL),(2,2,'Consig. Emprest.',272.25,NULL);
...
-- Dump completed on 2015-01-23 10:25:25
